...
O projeto integra o springdoc-openapi para documentação. Devido a migrações de ambiente para o ecossistema Jakarta, a interface visual do Swagger pode ser acessada via /v3/api-docs para extração da especificação JSON da API.
...
![Interface Principal](screenshot/index.png)
...
![Inserir Valor](screenshot/inserir_valor.png)
...
![Confirmação](screenshot/confirmacao.png)


![Dados H2](screenshot/dados_h2.png)
